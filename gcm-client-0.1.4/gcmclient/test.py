...
class GCMClientTest(unittest.TestCase):
    ...
    def setUp(self):
        self.gcm = GCM('AIzaSyAGW4D5BWfxk7kJLsyedhez-j9XQfMZdm4')
    ...
    def test_json_message(self):
        msg = JSONMessage(['Hola usuario', 'B', 'C', 'D', 'E'],
                {
                    'str': 'string',
                    'int': 90,
                    'bool': True,
        ...
        ex_data = json.dumps({'collapse_key': 'collapse.key',
                    ...
                    'delay_while_idle': True,
                    'dry_run': True,
                    'registration_ids': ['APA91bGQTuhxVFlf_tS7kst0--cLO-EhRURgrKin4fNOTI20H5nEPEokv9pGl1xVm9K6EpY9o1t99xkNDLYKnpCG8jtEhQdrXgpg2ZXgrqgoAPMFlKztSGFK9ps0jRBSDuAg2Q9nyGkn2FupGPQresT4EbkQ_n5OHg', 'B', 'C', 'D', 'E'],
                    'data': {
                        'str': 'string',
                        'int': 90,
                        'bool': True,
